...
Desde un navegador a la web de gestión de monitorización y accedemos como usuario \textbf{\emph{Admin}} con contraseña \textbf{\emph{zabbix}} para acceder como administrador para poder gestionar la monitorización.
    \begin{figure}[H]
        \centering
