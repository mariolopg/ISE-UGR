...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Apartado para la instalación del Front-End %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Apartado para la configuración de los hosts %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Configuración para la monitorización de los hosts}
    \subsection{Web de gestión de Zabbix}
    Desde un navegador a la \href{https://www.192.168.56.105/zabbix/index.php}{web de gestión de monitorización} y accedemos como usuario \textbf{\emph{Admin}} con contraseña \textbf{\emph{zabbix}}
    para acceder como administrador para poder gestionar la monitorización.
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.3]{images/zabbix_login.png}
    ...
    \begin{itemize}
        \item \textbf{Template App HTTP Service: } para monitorizar el servicio HTTP
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.425]{images/ubuntu_templates.png}
    ...
    Como el puerto del SSH es distinto al puerto por defecto, debemos indicarle al servicio SSH que nuestro puerto de SSH es el 22022. Para
    indicárselo pulsamos sobre el template \textbf{Template App SSH Service}, pulsamos sobre el apartado \textbf{Item} y por último,
    pulsamos sobre el apartado \textbf{SSH servie is running}. Editamos el apartado \textbf{key} de la siguiente forma:
    \begin{figure}[H]
        \centering
    ...
    \subsubsection{Apartado Host}
    En este apartado definiremos el nombre con el que identificaremos la máquina con CentOS, el grupo al que pertenece, la IP de la máquina y el puerto de escucha.
    Rellenamos los campos anteriores de la siguiente forma:
    \begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.425]{images/centos_templates.png}
